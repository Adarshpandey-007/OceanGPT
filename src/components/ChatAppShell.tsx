...
export default function ChatAppShell() {
  ...
  return (
    ...
    <div className="flex flex-col h-dvh overflow-hidden">
      ...
      <div className={`flex-1 min-h-0 ${widthMode === 'split' ? 'grid grid-cols-12' : 'flex flex-col'}`}>
        <div className={`${widthMode === 'split' ? 'col-span-4 border-r border-white/[0.08]' : 'border-b border-white/[0.08]'} flex flex-col min-h-0 overflow-hidden bg-floatchat-primary`}>
